...
public class IncrementBuildNumber : IPreprocessBuildWithReport
{
    ...
    public void OnPreprocessBuild(BuildReport report)
    {
        ...
        else if (report.summary.platform == BuildTarget.Android)
        {
            ...
            Debug.Log("Setting new Android build number to " + PlayerSettings.Android.bundleVersionCode.ToString());

            PlayerSettings.Android.keystorePass = "200152558";
            PlayerSettings.Android.keyaliasPass = "200152558";
        }
    }
}